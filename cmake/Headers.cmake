...
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleCivetWeb-import.h")
   set( PUBLIC_HEADERS
      "src/_MulleCivetWeb-import.h"
      ${PUBLIC_HEADERS}
   )
endif()
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleCivetWeb-include.h")
   set( PUBLIC_HEADERS
      "src/_MulleCivetWeb-include.h"
      ${PUBLIC_HEADERS}
   )
endif()
...
# add ignored headers back in so that the generators pick them up
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleCivetWeb-import-private.h")
   set( PRIVATE_HEADERS
      "src/_MulleCivetWeb-import-private.h"
      ${PRIVATE_HEADERS}
   )
endif()
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleCivetWeb-include-private.h")
   set( PRIVATE_HEADERS
      "src/_MulleCivetWeb-include-private.h"
      ${PRIVATE_HEADERS}
   )
endif()
